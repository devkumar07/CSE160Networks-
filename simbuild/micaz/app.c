...
#line 742
typedef int (*__compar_fn_t)(const void *arg_0x7f64cd1d2020, const void *arg_0x7f64cd1d2320);
#line 780
__extension__ 
#line 797
__extension__ 
...
#line 250
extern double erfc(double arg_0x7f64cd14a5e0) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 326
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0x7f64cceed3a0), 
int (*key_eq_fn)(void *arg_0x7f64cceedb70, void *arg_0x7f64cceede30));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0x7f64cccdac00, int arg_0x7f64cccdae80);
static double RandomUniform(void );
...
#line 332
                                    if (t.destNode != __nesc_ntoh_uint16(myMsg->src.nxdata)) {
                                        ...
                                        sim_log_debug(131U, TRANSPORT_CHANNEL, "ACK Msg Packet sent from Node %d, port %d to Node %d,Port %d with seqNum:%d\n", TOS_NODE_ID, temp->destPort, t.destNode, data.destPort, temp->seqNum);
                                        Node__Sender__send(Node__sendPackage[sim_node()], next);
                                      }
                                  }
                              }
                                ...
                                Node__makePack(&Node__sendPackage[sim_node()], TOS_NODE_ID, __nesc_ntoh_uint16(myMsg->src.nxdata), MAX_TTL, PROTOCOL_ACK, Node__seqNum[sim_node()], (uint8_t *)data_address, PACKET_MAX_PAYLOAD_SIZE);
                                next = Node__get_next_hop(__nesc_ntoh_uint16(myMsg->src.nxdata));
                                sim_log_debug(132U, TRANSPORT_CHANNEL, "ACK Packet sent from Node %d, port %d to Node %d,Port %d with seqNum:%d\n", TOS_NODE_ID, temp->destPort, __nesc_ntoh_uint16(myMsg->src.nxdata), temp->srcPort, temp->seqNum);
                                Node__Sender__send(Node__sendPackage[sim_node()], next);
                              }
                            }
                        }
...
#line 371
                            ...
                            sim_log_debug(133U, TRANSPORT_CHANNEL, "ACK received from node %d port %d to node %d port %d for seqNum %d \n", __nesc_ntoh_uint16(myMsg->src.nxdata), temp->srcPort, TOS_NODE_ID, temp->destPort, temp->seqNum);

                            if (temp->info == 1) {
                                sim_log_debug(134U, TRANSPORT_CHANNEL, "%s is BROADCASTING the message: %s\n", temp->username, temp->message);
                              }
                            ...
                            if (temp->seqNum - Node__sockets[sim_node()][temp->destPort].lastAck == 1) {
                                ...
                                sim_log_debug(135U, TRANSPORT_CHANNEL, "Received upto %d packet(s) \n", Node__sockets[sim_node()][temp->destPort].lastAck);
                              }
                          }
                        else {
...
#line 433
                              ...
                              if (__nesc_ntoh_uint8(myMsg->protocol.nxdata) == PROTOCOL_PING) {
                                  ...
                                  sim_log_debug(136U, ROUTING_CHANNEL, "Packet has arrived! %s\n", myMsg->payload);
                                }
                              }
                            }
                          }
...
#line 447
              {
                ...
                if (__nesc_ntoh_uint8(myMsg->protocol.nxdata) == PROTOCOL_LINKEDLIST) {
                    ...
                    if (i == Node__RouteTable__size()) {
                        sim_log_debug(138U, GENERAL_CHANNEL, "No Path Found\n");
                      }
                  }
                else {
                  if (__nesc_ntoh_uint8(myMsg->protocol.nxdata) == PROTOCOL_PING) {
...
#line 535
  ...
  sim_log_debug(145U, GENERAL_CHANNEL, "Unknown Packet Type %d\n", len);
  return msg;
}
...
# 78 "/opt/tinyos-main/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC__Receive__receive(am_id_t arg_0x7f64cc9c5e30, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x7f64cc9c5e30) {
#line 78
    case 6:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC__Receive__default__receive(arg_0x7f64cc9c5e30, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 78 "/opt/tinyos-main/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC__Snoop__receive(am_id_t arg_0x7f64cc9c4a50, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC__Snoop__default__receive(arg_0x7f64cc9c4a50, msg, payload, len);
#line 78
...
# 110 "/opt/tinyos-main/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC__AMSend__sendDone(am_id_t arg_0x7f64cc9dfc70, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__sendDone(arg_0x7f64cc9dfc70, msg, error);
#line 110
}
#line 110
...
#line 88
# 80 "/opt/tinyos-main/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__send(am_id_t arg_0x7f64cc1e6b60, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC__AMSend__send(arg_0x7f64cc1e6b60, addr, msg, len);
#line 80
...
# 100 "/opt/tinyos-main/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__sendDone(uint8_t arg_0x7f64cc1e7940, message_t * msg, error_t error){
#line 100
  switch (arg_0x7f64cc1e7940) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__default__sendDone(arg_0x7f64cc1e7940, msg, error);
#line 100
      break;
#line 100
    }
...
#line 609
  sim_log_debug(152U, TRANSPORT_CHANNEL, "result: %s\n", res1);
...
#line 614
      ...
      sim_log_debug(155U, TRANSPORT_CHANNEL, "res: %s\n", res);
...
#line 626
    if ((uint8_t )strcmp(res1, "msg") == 0) {
        ...
        sim_log_debug(157U, TRANSPORT_CHANNEL, "clientPort: %d\n", Node__clientPort[sim_node()]);
...
#line 635
      if ((uint8_t )strcmp(res1, "whisper") == 0) {
          Node__user[sim_node()] = strtok((void *)0, delimiter);
          sim_log_debug(158U, TRANSPORT_CHANNEL, "user %s\n", Node__user[sim_node()]);

          Node__message[sim_node()] = strtok((void *)0, "\n");
          sim_log_debug(159U, TRANSPORT_CHANNEL, "message: %s\n", Node__message[sim_node()]);
        }
      else {
#line 642
        if ((uint8_t )strcmp(res1, "listusr") == 0) {
          ...
          {
            sim_log_debug(160U, TRANSPORT_CHANNEL, "%s is not an option\n", res1);
          }
        }
      }
    }
...
#line 548
  sim_log_debug(146U, GENERAL_CHANNEL, "PING EVENT \n");
  sim_log_debug(147U, GENERAL_CHANNEL, "Packet source %d\n", TOS_NODE_ID);

  for (i = 0; i < Node__RouteTable__size(); i++) {
      r = Node__RouteTable__get(i);
      if (destination == (uint16_t )__nesc_ntoh_uint16(r.dest.nxdata) && __nesc_ntoh_uint16(r.cost.nxdata) < 20) {
          sim_log_debug(148U, ROUTING_CHANNEL, "Found a route!!! %d\n", __nesc_ntoh_uint16(r.nextHop.nxdata));
  ...
  if (i == Node__RouteTable__size()) {
      sim_log_debug(149U, GENERAL_CHANNEL, "No Path Found\n");
    }
}
...
# 75 "/opt/tinyos-main/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP__TaskBasic__runTask(uint8_t arg_0x7f64ccbae020){
#line 75
  switch (arg_0x7f64ccbae020) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP__TaskBasic__default__runTask(arg_0x7f64ccbae020);
#line 75
      break;
#line 75
    }
...
#line 776
{
  ...
  Node__seqNum[sim_node()]++;
  if (nexHop < 25) {
      sim_log_debug(172U, TRANSPORT_CHANNEL, "Syn Ack Packet sent to Node %d for Port %d with nextHop %d\n", dest_addr, destPort, nexHop);
      Node__Sender__send(Node__sendPackage[sim_node()], nexHop);
    }
}
...
#line 757
  sim_log_debug(169U, GENERAL_CHANNEL, "Target Node: %d\n", dest_addr);
  sim_log_debug(170U, GENERAL_CHANNEL, "Nexthop: %d\n", nexHop);
  data.username = Node__user[sim_node()];
  ...
  sim_log_debug(171U, GENERAL_CHANNEL, "want to open port: %d\n", data.destPort);
...
# 83 "/opt/tinyos-main/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__fired(uint8_t arg_0x7f64cc298950){
#line 83
  switch (arg_0x7f64cc298950) {
#line 83
    case 0U:
#line 83
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__default__fired(arg_0x7f64cc298950);
#line 83
      break;
#line 83
    }
...
#line 76
  sim_log_debug(241U, "QueueC", "head <-");
...
#line 81
          sim_log_debug_clear(243U, "QueueC", "%0.2hhx", v);
        }
      sim_log_debug_clear(244U, "QueueC", "] ");
    }
  sim_log_debug_clear(245U, "QueueC", "<- tail\n");
}
...
#line 860
  for (i = 0; i < Node__RouteTable__size(); i++) {
      ...
      if (dest_addr == (uint16_t )__nesc_ntoh_uint16(r.dest.nxdata) && __nesc_ntoh_uint16(r.cost.nxdata) < 255) {
          sim_log_debug(179U, ROUTING_CHANNEL, "next hop: %d\n", __nesc_ntoh_uint16(r.nextHop.nxdata));
...
#line 579
{
  ...
  sim_log_debug(150U, TRANSPORT_CHANNEL, "User in setTestClient: %s\n", Node__user[sim_node()]);
  Node__sockets[sim_node()][source_socket].RTT = 8000;
  sim_log_debug(151U, GENERAL_CHANNEL, "RTT: %d\n", Node__sockets[sim_node()][source_socket].RTT);
...
#line 802
{
  ...
  if (Node__instruction[sim_node()] == 1) {
      sim_log_debug(173U, TRANSPORT_CHANNEL, "in here tcp_send: %s\n", Node__message[sim_node()]);
      ...
      sim_log_debug(174U, TRANSPORT_CHANNEL, "TCP Msg Packet sent from Node %d, port %d to Node %d,Port %d with seqNum:%d\n", TOS_NODE_ID, data_address->srcPort, dest_addr, data_address->destPort, Node__nextPacket[sim_node()]);
      Node__sockets[sim_node()][srcPort].effectiveWindow--;
      sim_log_debug(175U, TRANSPORT_CHANNEL, "Updated Effective Window after sending packet to receiver: %d\n", Node__sockets[sim_node()][srcPort].effectiveWindow);
      Node__Sender__send(Node__sendPackage[sim_node()], nexHop);
    }
  else {
      Node__nextPacket[sim_node()]++;
      ...
      sim_log_debug(176U, TRANSPORT_CHANNEL, "data.username: %s\n", data.username);
      Node__makePack(&Node__sendPackage[sim_node()], TOS_NODE_ID, dest_addr, MAX_TTL, PROTOCOL_TCP, Node__seqNum[sim_node()], (uint8_t *)data_address, PACKET_MAX_PAYLOAD_SIZE);
      sim_log_debug(177U, TRANSPORT_CHANNEL, "TCP Packet sent from Node %d, port %d to Node %d,Port %d with seqNum:%d\n", TOS_NODE_ID, data_address->srcPort, dest_addr, data_address->destPort, Node__nextPacket[sim_node()]);
      Node__sockets[sim_node()][srcPort].effectiveWindow--;
      sim_log_debug(178U, TRANSPORT_CHANNEL, "Updated Effective Window after sending packet to receiver: %d\n", Node__sockets[sim_node()][srcPort].effectiveWindow);
      Node__Sender__send(Node__sendPackage[sim_node()], nexHop);
    }
}
...
#line 707
  if (Node__RouteTable__size() == 0) {
      ...
      sim_log_debug(164U, ROUTING_CHANNEL, "Creating table for: %d\n", TOS_NODE_ID);
      for (i = 0; i < Node__NeighborList__size(); i++) {
