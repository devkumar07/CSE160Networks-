...
#line 742
typedef int (*__compar_fn_t)(const void *arg_0x7efef0c66020, const void *arg_0x7efef0c66320);
#line 780
__extension__ 
#line 797
__extension__ 
...
#line 250
extern double erfc(double arg_0x7efef0bde5e0) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 326
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0x7efef09813a0), 
int (*key_eq_fn)(void *arg_0x7efef0981b70, void *arg_0x7efef0981e30));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0x7efef076ec00, int arg_0x7efef076ee80);
static double RandomUniform(void );
...
uint16_t Node__congestionWindow[1000];
...
#line 257
                    ...
                    if (Node__sockets[sim_node()][index].state == LISTEN) {
                      ...
                      {
                        sim_log_debug(116U, TRANSPORT_CHANNEL, "state: %s\n", Node__sockets[sim_node()][index].state);
                        sim_log_debug(117U, TRANSPORT_CHANNEL, "Unable to open port because Server port was not open\n");
                      }
                  }
                else {
...
#line 287
                      ...
                      sim_log_debug(118U, TRANSPORT_CHANNEL, "Connection ESTABLISHED for node %d in port %d\n", TOS_NODE_ID, index);
...
#line 307
                          if (__nesc_ntoh_uint8(myMsg->payload[3].nxdata) > 5) {
                              sim_log_debug(121U, TRANSPORT_CHANNEL, "CONGESTION WINDOW: %d, greater than 5\n", __nesc_ntoh_uint8(myMsg->payload[3].nxdata));
                              Node__TCP_Timeout__startOneShot(0);
                            }
                          else 
                            {
                              if (Node__sockets[sim_node()][__nesc_ntoh_uint8(myMsg->payload[1].nxdata)].state == SYN_RCVD) {
                                  sim_log_debug(122U, TRANSPORT_CHANNEL, "Changing receiver state to established\n");
...
#line 328
                            ...
                            sim_log_debug(124U, TRANSPORT_CHANNEL, "ACK received from node %d port %d to node %d port %d for seqNum %d \n", __nesc_ntoh_uint16(myMsg->src.nxdata), __nesc_ntoh_uint8(myMsg->payload[0].nxdata), TOS_NODE_ID, __nesc_ntoh_uint8(myMsg->payload[1].nxdata), __nesc_ntoh_uint8(myMsg->payload[2].nxdata));

                            Node__sockets[sim_node()][__nesc_ntoh_uint8(myMsg->payload[1].nxdata)].effectiveWindow++;
                            Node__congestionWindow[sim_node()]++;
                            sim_log_debug(125U, TRANSPORT_CHANNEL, "effective Window: %d, congestion window %d\n", Node__sockets[sim_node()][__nesc_ntoh_uint8(myMsg->payload[1].nxdata)].effectiveWindow, Node__congestionWindow[sim_node()]);
...
#line 388
                              ...
                              if (__nesc_ntoh_uint8(myMsg->protocol.nxdata) == PROTOCOL_PING) {
                                  ...
                                  sim_log_debug(128U, ROUTING_CHANNEL, "Packet has arrived! %s\n", myMsg->payload);
                                }
                              }
                            }
                          }
...
#line 402
              {
                ...
                if (__nesc_ntoh_uint8(myMsg->protocol.nxdata) == PROTOCOL_LINKEDLIST) {
                    ...
                    if (i == Node__RouteTable__size()) {
                        sim_log_debug(130U, GENERAL_CHANNEL, "No Path Found\n");
                      }
                  }
                else {
                  if (__nesc_ntoh_uint8(myMsg->protocol.nxdata) == PROTOCOL_PING) {
...
# 78 "/opt/tinyos-main/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC__Receive__receive(am_id_t arg_0x7efef045de30, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x7efef045de30) {
#line 78
    case 6:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC__Receive__default__receive(arg_0x7efef045de30, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 78 "/opt/tinyos-main/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC__Snoop__receive(am_id_t arg_0x7efef045ca50, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC__Snoop__default__receive(arg_0x7efef045ca50, msg, payload, len);
#line 78
...
# 110 "/opt/tinyos-main/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC__AMSend__sendDone(am_id_t arg_0x7efef0477c70, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__sendDone(arg_0x7efef0477c70, msg, error);
#line 110
}
#line 110
...
#line 88
# 80 "/opt/tinyos-main/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__send(am_id_t arg_0x7efeefc3fb60, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC__AMSend__send(arg_0x7efeefc3fb60, addr, msg, len);
#line 80
...
# 100 "/opt/tinyos-main/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__sendDone(uint8_t arg_0x7efeefc40940, message_t * msg, error_t error){
#line 100
  switch (arg_0x7efeefc40940) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__default__sendDone(arg_0x7efeefc40940, msg, error);
#line 100
      break;
#line 100
    }
...
#line 535
{
  ...
  Node__sockets[sim_node()][source_socket].effectiveWindow = 1;
  Node__congestionWindow[sim_node()] = 1;
  sim_log_debug(143U, TRANSPORT_CHANNEL, "Congestion Window: %d\n", Node__congestionWindow[sim_node()]);
...
#line 22
{
  if (!CommandHandlerP__Queue__empty()) {
      ...
      sim_log_debug(205U, COMMAND_CHANNEL, "A Command has been Issued.\n");
...
# 75 "/opt/tinyos-main/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP__TaskBasic__runTask(uint8_t arg_0x7efef0642020){
#line 75
  switch (arg_0x7efef0642020) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP__TaskBasic__default__runTask(arg_0x7efef0642020);
#line 75
      break;
#line 75
    }
...
#line 669
  sim_log_debug(152U, GENERAL_CHANNEL, "Target Node: %d\n", dest_addr);
  sim_log_debug(153U, GENERAL_CHANNEL, "Nexthop: %d\n", nexHop);

  Node__port_info[sim_node()][0] = srcPort;
  Node__port_info[sim_node()][1] = destPort;
  sim_log_debug(154U, GENERAL_CHANNEL, "want to open port: %d\n", Node__port_info[sim_node()][1]);
  ...
  for (i = 0; i < MAX_NUM_OF_SOCKETS; i++) {
      if (Node__sockets[sim_node()][i].state == ESTABLISHED) {
          if (Node__sockets[sim_node()][i].flag == TOS_NODE_ID && Node__nextPacket[sim_node()] <= 250) {
              ...
              Node__sockets[sim_node()][i].effectiveWindow = Node__congestionWindow[sim_node()] / 2;
              if (Node__sockets[sim_node()][i].effectiveWindow <= 0) {
                  Node__sockets[sim_node()][i].effectiveWindow = 1;
                }
              Node__congestionWindow[sim_node()] = Node__sockets[sim_node()][i].effectiveWindow;
              sim_log_debug(113U, TRANSPORT_CHANNEL, "TIMEOUT Congestion Window %d\n", Node__congestionWindow[sim_node()]);
...
# 83 "/opt/tinyos-main/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__fired(uint8_t arg_0x7efeefcf1950){
#line 83
  switch (arg_0x7efeefcf1950) {
#line 83
    case 0U:
#line 83
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__default__fired(arg_0x7efeefcf1950);
#line 83
      break;
#line 83
    }
...
#line 682
{
  ...
  Node__seqNum[sim_node()]++;
  if (nexHop < 25) {
      sim_log_debug(155U, TRANSPORT_CHANNEL, "Syn Ack Packet sent to Node %d for Port %d with nextHop %d\n", dest_addr, destPort, nexHop);
      Node__Sender__send(Node__sendPackage[sim_node()], nexHop);
    }
}
...
#line 727
  for (i = 0; i < Node__RouteTable__size(); i++) {
      ...
      if (dest_addr == (uint16_t )__nesc_ntoh_uint16(r.dest.nxdata) && __nesc_ntoh_uint16(r.cost.nxdata) < 255) {
          sim_log_debug(158U, ROUTING_CHANNEL, "next hop: %d\n", __nesc_ntoh_uint16(r.nextHop.nxdata));
...
#line 700
{
  ...
  Node__port_info[sim_node()][3] = Node__congestionWindow[sim_node()];
  ...
  sim_log_debug(156U, TRANSPORT_CHANNEL, "TCP Packet sent from Node %d, port %d to Node %d,Port %d with seqNum:%d\n", TOS_NODE_ID, Node__port_info[sim_node()][0], dest_addr, Node__port_info[sim_node()][1], Node__nextPacket[sim_node()]);



  Node__sockets[sim_node()][srcPort].effectiveWindow--;
  sim_log_debug(157U, TRANSPORT_CHANNEL, "Updated Effective Window after sending packet to receiver: %d\n", Node__sockets[sim_node()][srcPort].effectiveWindow);
  Node__Sender__send(Node__sendPackage[sim_node()], nexHop);
}
...
#line 621
  if (Node__RouteTable__size() == 0) {
      ...
      sim_log_debug(147U, ROUTING_CHANNEL, "Creating table for: %d\n", TOS_NODE_ID);
      for (i = 0; i < Node__NeighborList__size(); i++) {
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  if (!strcmp(varname, "Node__congestionWindow"))
  {
    *addr = (uintptr_t)&Node__congestionWindow[__nesc_mote];
    *size = sizeof(Node__congestionWindow[__nesc_mote]);
    return 0;
  }
...
static void __nesc_nido_initialise(int __nesc_mote)
{
  ...
  Node__congestionWindow[__nesc_mote] = 0;
