...
#line 742
typedef int (*__compar_fn_t)(const void *arg_0x7fdd7e030020, const void *arg_0x7fdd7e030320);
#line 780
__extension__ 
#line 797
__extension__ 
...
#line 250
extern double erfc(double arg_0x7fdd7dfa85e0) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 326
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0x7fdd7dd4b3a0), 
int (*key_eq_fn)(void *arg_0x7fdd7dd4bb70, void *arg_0x7fdd7dd4be30));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0x7fdd7db38c00, int arg_0x7fdd7db38e80);
static double RandomUniform(void );
...
#line 242
                    ...
                    if (Node__sockets[sim_node()][index].state == LISTEN || Node__sockets[sim_node()][index].state == ESTABLISHED) {
                        ...
                        sim_log_debug(112U, TRANSPORT_CHANNEL, "state: %d\n", Node__sockets[sim_node()][index].state);
...
#line 276
                      ...
                      sim_log_debug(114U, TRANSPORT_CHANNEL, "TCP SUCCESSFULLY CONNECTED! Hello %s\n", temp->username);
...
#line 365
                                  sim_log_debug(117U, TRANSPORT_CHANNEL, "from %s to %s\n", usr, receiver);
                                  sim_log_debug(118U, TRANSPORT_CHANNEL, "message in WHISPER received: %s\n", temp->message);
                                  for (i = 0; i < Node__ClientsDB__size(); i++) {
                                      ConnectedClients t = Node__ClientsDB__get(i);
...
#line 446
                            ...
                            if (temp->info == 1) {
                                sim_log_debug(119U, TRANSPORT_CHANNEL, "%s BROADCASTED the message: %s\n", temp->username, temp->message);
                              }
                            else {
#line 452
                              if (temp->info == 2) {
                                  sim_log_debug(120U, TRANSPORT_CHANNEL, "%s UNICASTED the message: %s\n", temp->username, temp->message);
                                }
                              else {
#line 455
                                if (temp->info == 3) {
                                    sim_log_debug(121U, TRANSPORT_CHANNEL, "%s sent client list: %s\n", temp->username, temp->message);
                                  }
                                }
                              }
#line 458
...
#line 514
                              ...
                              if (__nesc_ntoh_uint8(myMsg->protocol.nxdata) == PROTOCOL_PING) {
                                  ...
                                  sim_log_debug(122U, ROUTING_CHANNEL, "Packet has arrived! %s\n", myMsg->payload);
                                }
                              }
                            }
                          }
...
# 78 "/opt/tinyos-main/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC__Receive__receive(am_id_t arg_0x7fdd7d823e30, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x7fdd7d823e30) {
#line 78
    case 6:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC__Receive__default__receive(arg_0x7fdd7d823e30, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 78 "/opt/tinyos-main/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC__Snoop__receive(am_id_t arg_0x7fdd7d822a50, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC__Snoop__default__receive(arg_0x7fdd7d822a50, msg, payload, len);
#line 78
...
# 110 "/opt/tinyos-main/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC__AMSend__sendDone(am_id_t arg_0x7fdd7d82bc70, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__sendDone(arg_0x7fdd7d82bc70, msg, error);
#line 110
}
#line 110
...
#line 88
# 80 "/opt/tinyos-main/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__send(am_id_t arg_0x7fdd7d047b60, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC__AMSend__send(arg_0x7fdd7d047b60, addr, msg, len);
#line 80
...
#line 133
        {
          ...
          sim_log_debug(146U, GENERAL_CHANNEL, "The radio is busy, or something\n");
          return FAIL;
        }
    }
  else 
#line 138
    {
      sim_log_debug(147U, GENERAL_CHANNEL, "The radio is busy");
      return EBUSY;
    }


  sim_log_debug(148U, GENERAL_CHANNEL, "FAILED!?");
  return FAIL;
}
...
# 100 "/opt/tinyos-main/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__sendDone(uint8_t arg_0x7fdd7d048940, message_t * msg, error_t error){
#line 100
  switch (arg_0x7fdd7d048940) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__default__sendDone(arg_0x7fdd7d048940, msg, error);
#line 100
      break;
#line 100
    }
...
#line 726
        if ((uint8_t )strcmp(res1, "listusr") == 0) {
            ...
            sim_log_debug(136U, TRANSPORT_CHANNEL, "%s is not an option\n", res1);
          }
        }
      }
    }
...
#line 22
{
  if (!CommandHandlerP__Queue__empty()) {
      ...
      sim_log_debug(192U, COMMAND_CHANNEL, "A Command has been Issued.\n");
...
# 75 "/opt/tinyos-main/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP__TaskBasic__runTask(uint8_t arg_0x7fdd7da0c020){
#line 75
  switch (arg_0x7fdd7da0c020) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP__TaskBasic__default__runTask(arg_0x7fdd7da0c020);
#line 75
      break;
#line 75
    }
...
# 83 "/opt/tinyos-main/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__fired(uint8_t arg_0x7fdd7d0f9950){
#line 83
  switch (arg_0x7fdd7d0f9950) {
#line 83
    case 0U:
#line 83
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__default__fired(arg_0x7fdd7d0f9950);
#line 83
      break;
#line 83
    }
...
#line 1000
  for (i = 0; i < Node__RouteTable__size(); i++) {
      ...
      if (dest_addr == (uint16_t )__nesc_ntoh_uint16(r.dest.nxdata) && __nesc_ntoh_uint16(r.cost.nxdata) < 255) {
          sim_log_debug(145U, ROUTING_CHANNEL, "next hop: %d\n", __nesc_ntoh_uint16(r.nextHop.nxdata));
