...
#line 742
typedef int (*__compar_fn_t)(const void *arg_0x7fa34c882020, const void *arg_0x7fa34c882320);
#line 780
__extension__ 
#line 797
__extension__ 
...
#line 250
extern double erfc(double arg_0x7fa34c7fa5e0) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 326
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0x7fa34c59d3a0), 
int (*key_eq_fn)(void *arg_0x7fa34c59db70, void *arg_0x7fa34c59de30));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0x7fa34c38ac00, int arg_0x7fa34c38ae80);
static double RandomUniform(void );
...
#line 404
                              ...
                              if (__nesc_ntoh_uint8(myMsg->protocol.nxdata) == PROTOCOL_PING) {
                                  ...
                                  sim_log_debug(129U, ROUTING_CHANNEL, "Packet has arrived! %s\n", myMsg->payload);
                                }
                              }
                            }
                          }
...
#line 418
              {
                ...
                if (__nesc_ntoh_uint8(myMsg->protocol.nxdata) == PROTOCOL_LINKEDLIST) {
                    ...
                    if (i == Node__RouteTable__size()) {
                        sim_log_debug(131U, GENERAL_CHANNEL, "No Path Found\n");
                      }
                  }
                else {
                  if (__nesc_ntoh_uint8(myMsg->protocol.nxdata) == PROTOCOL_PING) {
...
#line 506
  ...
  sim_log_debug(138U, GENERAL_CHANNEL, "Unknown Packet Type %d\n", len);
  return msg;
}
...
# 78 "/opt/tinyos-main/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC__Receive__receive(am_id_t arg_0x7fa34c076e30, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x7fa34c076e30) {
#line 78
    case 6:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC__Receive__default__receive(arg_0x7fa34c076e30, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 78 "/opt/tinyos-main/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC__Snoop__receive(am_id_t arg_0x7fa34c075a50, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC__Snoop__default__receive(arg_0x7fa34c075a50, msg, payload, len);
#line 78
...
# 110 "/opt/tinyos-main/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC__AMSend__sendDone(am_id_t arg_0x7fa34c07ec70, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__sendDone(arg_0x7fa34c07ec70, msg, error);
#line 110
}
#line 110
...
#line 88
# 80 "/opt/tinyos-main/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__send(am_id_t arg_0x7fa34b8b2b60, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC__AMSend__send(arg_0x7fa34b8b2b60, addr, msg, len);
#line 80
...
# 100 "/opt/tinyos-main/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__sendDone(uint8_t arg_0x7fa34b8b3940, message_t * msg, error_t error){
#line 100
  switch (arg_0x7fa34b8b3940) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__default__sendDone(arg_0x7fa34b8b3940, msg, error);
#line 100
      break;
#line 100
    }
...
#line 580
  sim_log_debug(145U, TRANSPORT_CHANNEL, "result: %s\n", res1);
...
#line 585
      ...
      sim_log_debug(147U, TRANSPORT_CHANNEL, "clientport %d\n", Node__clientPort[sim_node()]);
...
#line 595
    if ((uint8_t )strcmp(res1, "msg") == 0) {
        ...
        sim_log_debug(148U, TRANSPORT_CHANNEL, "message: %s\n", Node__message[sim_node()]);
        Node__cmd[sim_node()] = res1;
...
#line 610
        if ((uint8_t )strcmp(res1, "listusr") == 0) {
          ...
          {
            sim_log_debug(152U, TRANSPORT_CHANNEL, "%s is not an option\n", res1);
          }
        }
      }
    }
...
#line 519
  sim_log_debug(139U, GENERAL_CHANNEL, "PING EVENT \n");
  sim_log_debug(140U, GENERAL_CHANNEL, "Packet source %d\n", TOS_NODE_ID);

  for (i = 0; i < Node__RouteTable__size(); i++) {
      r = Node__RouteTable__get(i);
      if (destination == (uint16_t )__nesc_ntoh_uint16(r.dest.nxdata) && __nesc_ntoh_uint16(r.cost.nxdata) < 20) {
          sim_log_debug(141U, ROUTING_CHANNEL, "Found a route!!! %d\n", __nesc_ntoh_uint16(r.nextHop.nxdata));
  ...
  if (i == Node__RouteTable__size()) {
      sim_log_debug(142U, GENERAL_CHANNEL, "No Path Found\n");
    }
}
...
#line 22
{
  if (!CommandHandlerP__Queue__empty()) {
      ...
      sim_log_debug(217U, COMMAND_CHANNEL, "A Command has been Issued.\n");
...
# 75 "/opt/tinyos-main/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP__TaskBasic__runTask(uint8_t arg_0x7fa34c25e020){
#line 75
  switch (arg_0x7fa34c25e020) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP__TaskBasic__default__runTask(arg_0x7fa34c25e020);
#line 75
      break;
#line 75
    }
...
#line 744
{
  ...
  Node__seqNum[sim_node()]++;
  if (nexHop < 25) {
      sim_log_debug(164U, TRANSPORT_CHANNEL, "Syn Ack Packet sent to Node %d for Port %d with nextHop %d\n", dest_addr, destPort, nexHop);
      Node__Sender__send(Node__sendPackage[sim_node()], nexHop);
    }
}
...
#line 725
  sim_log_debug(161U, GENERAL_CHANNEL, "Target Node: %d\n", dest_addr);
  sim_log_debug(162U, GENERAL_CHANNEL, "Nexthop: %d\n", nexHop);
  data.username = Node__user[sim_node()];
  ...
  sim_log_debug(163U, GENERAL_CHANNEL, "want to open port: %d\n", __nesc_ntoh_uint16(data.destPort.nxdata));
...
# 83 "/opt/tinyos-main/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__fired(uint8_t arg_0x7fa34b964950){
#line 83
  switch (arg_0x7fa34b964950) {
#line 83
    case 0U:
#line 83
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__default__fired(arg_0x7fa34b964950);
#line 83
      break;
#line 83
    }
...
#line 806
  for (i = 0; i < Node__RouteTable__size(); i++) {
      ...
      if (dest_addr == (uint16_t )__nesc_ntoh_uint16(r.dest.nxdata) && __nesc_ntoh_uint16(r.cost.nxdata) < 255) {
          sim_log_debug(170U, ROUTING_CHANNEL, "next hop: %d\n", __nesc_ntoh_uint16(r.nextHop.nxdata));
...
#line 550
{
  ...
  sim_log_debug(143U, TRANSPORT_CHANNEL, "User in setTestClient: %s\n", Node__user[sim_node()]);
...
#line 774
  sim_log_debug(165U, TRANSPORT_CHANNEL, "in here tcp send\n");
  sim_log_debug(166U, TRANSPORT_CHANNEL, "in here tcp send %s\n", Node__cmd[sim_node()]);


  if ((uint8_t )strcmp(Node__cmd[sim_node()], "msg") == 0) {
      sim_log_debug(167U, TRANSPORT_CHANNEL, "in here\n");
    }
  else {
      ...
      sim_log_debug(168U, TRANSPORT_CHANNEL, "TCP Packet sent from Node %d, port %d to Node %d,Port %d with seqNum:%d\n", TOS_NODE_ID, __nesc_ntoh_uint16(data_address->srcPort.nxdata), dest_addr, __nesc_ntoh_uint16(data_address->destPort.nxdata), Node__nextPacket[sim_node()]);
      Node__sockets[sim_node()][srcPort].effectiveWindow--;
      sim_log_debug(169U, TRANSPORT_CHANNEL, "Updated Effective Window after sending packet to receiver: %d\n", Node__sockets[sim_node()][srcPort].effectiveWindow);
      Node__Sender__send(Node__sendPackage[sim_node()], nexHop);
    }
}
...
#line 675
  if (Node__RouteTable__size() == 0) {
      ...
      sim_log_debug(156U, ROUTING_CHANNEL, "Creating table for: %d\n", TOS_NODE_ID);
      for (i = 0; i < Node__NeighborList__size(); i++) {
