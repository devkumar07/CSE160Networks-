...
#line 742
typedef int (*__compar_fn_t)(const void *arg_0x7f629a231020, const void *arg_0x7f629a231320);
#line 780
__extension__ 
#line 797
__extension__ 
...
#line 250
extern double erfc(double arg_0x7f629a1a95e0) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 326
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0x7f6299f4c3a0), 
int (*key_eq_fn)(void *arg_0x7f6299f4cb70, void *arg_0x7f6299f4ce30));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0x7f6299d39c00, int arg_0x7f6299d39e80);
static double RandomUniform(void );
...
#line 234
                    ...
                    if (Node__sockets[sim_node()][index].state == LISTEN || Node__sockets[sim_node()][index].state == ESTABLISHED) {
                        ...
                        sim_log_debug(114U, TRANSPORT_CHANNEL, "state: %d\n", Node__sockets[sim_node()][index].state);
...
#line 266
                      ...
                      sim_log_debug(117U, TRANSPORT_CHANNEL, "TCP SUCCESSFULLY CONNECTED! Hello %s\n", temp->username);
...
#line 298
                          ...
                          if (Node__sockets[sim_node()][temp->destPort].state == SYN_RCVD) {
                              sim_log_debug(120U, TRANSPORT_CHANNEL, "Changing receiver state to established\n");
...
#line 333
                                    if (__nesc_ntoh_uint16(t.srcNode.nxdata) != __nesc_ntoh_uint16(myMsg->src.nxdata)) {
                                        ...
                                        sim_log_debug(121U, TRANSPORT_CHANNEL, "ACK Msg Packet sent from Node %d, port %d to Node %d,Port %d with seqNum:%d\n", TOS_NODE_ID, temp->destPort, __nesc_ntoh_uint16(t.srcNode.nxdata), data.destPort, temp->seqNum);
                                        Node__TCP_Timer__startOneShot(Node__sockets[sim_node()][temp->destPort].RTT * 2);
                                        Node__Sender__send(Node__sendPackage[sim_node()], next);
                                      }
                                  }
...
#line 359
                                      if (__nesc_ntoh_uint16(t.srcNode.nxdata) != __nesc_ntoh_uint16(myMsg->src.nxdata) && strcmp(t.username, receiver) == 0) {
                                          ...
                                          Node__makePack(&Node__sendPackage[sim_node()], TOS_NODE_ID, __nesc_ntoh_uint16(t.srcNode.nxdata), MAX_TTL, PROTOCOL_ACK, Node__seqNum[sim_node()], (uint8_t *)data_address, PACKET_MAX_PAYLOAD_SIZE);
                                          next = Node__get_next_hop(__nesc_ntoh_uint16(t.srcNode.nxdata));
                                          sim_log_debug(122U, TRANSPORT_CHANNEL, "ACK Whisper Packet sent from Node %d, port %d to Node %d,Port %d with seqNum:%d\n", TOS_NODE_ID, temp->destPort, __nesc_ntoh_uint16(t.srcNode.nxdata), data.destPort, temp->seqNum);
                                          Node__Sender__send(Node__sendPackage[sim_node()], next);
                                        }
                                    }
                                }
...
#line 382
                                    ...
                                    sim_log_debug(123U, TRANSPORT_CHANNEL, "list message: %s\n", temp->message);
                                    for (i = 0; i < Node__ClientsDB__size(); i++) {
                                        ConnectedClients t = Node__ClientsDB__get(i);
...
#line 437
                            ...
                            if (temp->info == 1) {
                                sim_log_debug(124U, TRANSPORT_CHANNEL, "%s BROADCASTED the message: %s\n", temp->username, temp->message);
                              }
                            else {
#line 443
                              if (temp->info == 2) {
                                  sim_log_debug(125U, TRANSPORT_CHANNEL, "%s UNICASTED the message: %s\n", temp->username, temp->message);
                                }
                              else {
#line 446
                                if (temp->info == 3) {
                                    sim_log_debug(126U, TRANSPORT_CHANNEL, "%s sent client list: %s\n", temp->username, temp->message);
                                  }
                                }
                              }
#line 449
...
# 78 "/opt/tinyos-main/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC__Receive__receive(am_id_t arg_0x7f6299a24e30, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x7f6299a24e30) {
#line 78
    case 6:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC__Receive__default__receive(arg_0x7f6299a24e30, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 78 "/opt/tinyos-main/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC__Snoop__receive(am_id_t arg_0x7f6299a23a50, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC__Snoop__default__receive(arg_0x7f6299a23a50, msg, payload, len);
#line 78
...
# 110 "/opt/tinyos-main/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC__AMSend__sendDone(am_id_t arg_0x7f6299a2cc70, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__sendDone(arg_0x7f6299a2cc70, msg, error);
#line 110
}
#line 110
...
#line 88
# 80 "/opt/tinyos-main/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__send(am_id_t arg_0x7f629923db60, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC__AMSend__send(arg_0x7f629923db60, addr, msg, len);
#line 80
...
# 100 "/opt/tinyos-main/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__sendDone(uint8_t arg_0x7f629923e940, message_t * msg, error_t error){
#line 100
  switch (arg_0x7f629923e940) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__default__sendDone(arg_0x7f629923e940, msg, error);
#line 100
      break;
#line 100
    }
...
#line 717
        if ((uint8_t )strcmp(res1, "listusr") == 0) {
            ...
            sim_log_debug(144U, TRANSPORT_CHANNEL, "%s is not an option\n", res1);
          }
        }
      }
    }
...
#line 22
{
  if (!CommandHandlerP__Queue__empty()) {
      ...
      sim_log_debug(200U, COMMAND_CHANNEL, "A Command has been Issued.\n");
...
# 75 "/opt/tinyos-main/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP__TaskBasic__runTask(uint8_t arg_0x7f6299c0d020){
#line 75
  switch (arg_0x7f6299c0d020) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP__TaskBasic__default__runTask(arg_0x7f6299c0d020);
#line 75
      break;
#line 75
    }
...
#line 107
          if (Node__sockets[sim_node()][i].state == ESTABLISHED) {
              ...
              if (Node__sockets[sim_node()][i].flag == TOS_NODE_ID && Node__nextPacket[sim_node()] < 1) {
                  Node__sockets[sim_node()][i].nextExpected = 1;
...
# 83 "/opt/tinyos-main/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__fired(uint8_t arg_0x7f62992ef950){
#line 83
  switch (arg_0x7f62992ef950) {
#line 83
    case 0U:
#line 83
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__default__fired(arg_0x7f62992ef950);
#line 83
      break;
#line 83
    }
...
#line 991
  for (i = 0; i < Node__RouteTable__size(); i++) {
      ...
      if (dest_addr == (uint16_t )__nesc_ntoh_uint16(r.dest.nxdata) && __nesc_ntoh_uint16(r.cost.nxdata) < 255) {
          sim_log_debug(153U, ROUTING_CHANNEL, "next hop: %d\n", __nesc_ntoh_uint16(r.nextHop.nxdata));
...
#line 783
  if (Node__RouteTable__size() == 0) {
      ...
      sim_log_debug(148U, ROUTING_CHANNEL, "Creating table for: %d\n", TOS_NODE_ID);
      for (i = 0; i < Node__NeighborList__size(); i++) {
