...
#line 742
typedef int (*__compar_fn_t)(const void *arg_0x7fb89d27b020, const void *arg_0x7fb89d27b320);
#line 780
__extension__ 
#line 797
__extension__ 
...
#line 250
extern double erfc(double arg_0x7fb89d1f35e0) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 326
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0x7fb89cf963a0), 
int (*key_eq_fn)(void *arg_0x7fb89cf96b70, void *arg_0x7fb89cf96e30));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0x7fb89cd83c00, int arg_0x7fb89cd83e80);
static double RandomUniform(void );
...
uint8_t Node__nextPacket[1000];
uint8_t Node__port_info[1000][PACKET_MAX_PAYLOAD_SIZE];
bool Node__packets_sender[1000][10000];
bool Node__packets_receiver[1000][10000];
...
static inline void Node__CommandHandler__setClientClose(uint8_t client_addr, uint8_t dest_addr, uint8_t srcPort, uint8_t destPort);
#line 454
static void Node__makePack(pack *Package, uint16_t src, uint16_t dest, uint16_t TTL, uint16_t protocol, uint16_t seq, uint8_t *payload, uint8_t length);
...
#line 160
                          if (__nesc_ntoh_uint16(temp->dest.nxdata) == __nesc_ntoh_uint16(r->dest.nxdata)) {
                              ...
                              if (__nesc_ntoh_uint16(r->cost.nxdata) < __nesc_ntoh_uint16(temp->cost.nxdata)) {
                                  sim_log_debug(111U, ROUTING_CHANNEL, "Found a better path. Taking: %d\n", __nesc_ntoh_uint16(myMsg->src.nxdata));
...
#line 199
                    ...
                    if (Node__sockets[sim_node()][index].state == LISTEN) {
                        sim_log_debug(112U, TRANSPORT_CHANNEL, "Syn Packet Arrived from Node %d for Port %d\n", __nesc_ntoh_uint16(myMsg->src.nxdata), index);
                        ...
                        Node__makePack(&Node__sendPackage[sim_node()], TOS_NODE_ID, __nesc_ntoh_uint16(myMsg->src.nxdata), MAX_TTL, PROTOCOL_SYN_ACK, Node__seqNum[sim_node()], (uint8_t *)Node__port_info[sim_node()], PACKET_MAX_PAYLOAD_SIZE);
                        next = Node__get_next_hop(__nesc_ntoh_uint16(myMsg->src.nxdata));
                        Node__seqNum[sim_node()]++;
                        sim_log_debug(113U, TRANSPORT_CHANNEL, "Syn Ack Packet sent to Node %d for Port %d\n", __nesc_ntoh_uint16(myMsg->src.nxdata), index);
...
#line 218
                      index = __nesc_ntoh_uint8(myMsg->payload[1].nxdata);
                      sim_log_debug(115U, TRANSPORT_CHANNEL, "Connection ESTABLISHED for node %d in port %d\n", TOS_NODE_ID, index);
...
#line 236
                          ...
                          Node__packets_receiver[sim_node()][__nesc_ntoh_uint8(myMsg->payload[2].nxdata)] = 1;
...
#line 247
                            Node__packets_sender[sim_node()][__nesc_ntoh_uint8(myMsg->payload[2].nxdata)] = 1;
                            sim_log_debug(119U, TRANSPORT_CHANNEL, "ACK received: %d\n", __nesc_ntoh_uint8(myMsg->payload[2].nxdata));
                            Node__TCP_Timeout__stop();
                            if (__nesc_ntoh_uint8(myMsg->payload[2].nxdata) % 4 == 0) {
...
#line 254
                                for (j = 1; j <= 4; j++) {
                                    sim_log_debug(120U, TRANSPORT_CHANNEL, "TCP Packet sent from Node %d, port %d to Node %d,Port %d with seqNum:%d\n", __nesc_ntoh_uint16(myMsg->src.nxdata), __nesc_ntoh_uint8(myMsg->payload[0].nxdata), TOS_NODE_ID, __nesc_ntoh_uint8(myMsg->payload[1].nxdata), Node__nextPacket[sim_node()]);
                                    Node__send_TCP(Node__sockets[sim_node()][Node__socket[sim_node()]].src, __nesc_ntoh_uint16(Node__sockets[sim_node()][Node__socket[sim_node()]].dest.addr.nxdata), __nesc_ntoh_uint8(Node__sockets[sim_node()][Node__socket[sim_node()]].dest.port.nxdata));
                                  }
                              }
                          }
                        else {
...
#line 317
              {
                ...
                if (__nesc_ntoh_uint8(myMsg->protocol.nxdata) == PROTOCOL_LINKEDLIST) {
                    ...
                    if (i == Node__RouteTable__size()) {
                        sim_log_debug(122U, GENERAL_CHANNEL, "No Path Found\n");
                      }
                  }
                else {
                  if (__nesc_ntoh_uint8(myMsg->protocol.nxdata) == PROTOCOL_PING) {
                      ...
                      Node__seqNum[sim_node()]++;
                      Node__addPacketList(Node__sendPackage[sim_node()]);
                      sim_log_debug(123U, ROUTING_CHANNEL, "REROUTING for the ping event from %d to %d\n", TOS_NODE_ID, Node__get_next_hop(__nesc_ntoh_uint16(myMsg->dest.nxdata)));
...
#line 384
  ...
  sim_log_debug(129U, GENERAL_CHANNEL, "Unknown Packet Type %d\n", len);
  return msg;
}
...
# 78 "/opt/tinyos-main/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC__Receive__receive(am_id_t arg_0x7fb89ca72e30, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x7fb89ca72e30) {
#line 78
    case 6:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC__Receive__default__receive(arg_0x7fb89ca72e30, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 78 "/opt/tinyos-main/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC__Snoop__receive(am_id_t arg_0x7fb89ca71a50, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC__Snoop__default__receive(arg_0x7fb89ca71a50, msg, payload, len);
#line 78
...
#line 62
{
  if (err == SUCCESS) {
      ...
      Node__periodicTimer1__startPeriodic(20000);
...
# 110 "/opt/tinyos-main/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC__AMSend__sendDone(am_id_t arg_0x7fb89ca8cc70, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__sendDone(arg_0x7fb89ca8cc70, msg, error);
#line 110
}
#line 110
...
#line 88
# 80 "/opt/tinyos-main/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__send(am_id_t arg_0x7fb89c30db60, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC__AMSend__send(arg_0x7fb89c30db60, addr, msg, len);
#line 80
...
# 100 "/opt/tinyos-main/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__sendDone(uint8_t arg_0x7fb89c30f940, message_t * msg, error_t error){
#line 100
  switch (arg_0x7fb89c30f940) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__default__sendDone(arg_0x7fb89c30f940, msg, error);
#line 100
      break;
#line 100
    }
...
#line 424
{
  ...
  Node__TCP_Timer__startPeriodic(100000);
}
...
#line 429
{
  ...
  Node__sockets[sim_node()][source_socket].RTT = data * 10;
  sim_log_debug(134U, GENERAL_CHANNEL, "RTT: %d\n", Node__sockets[sim_node()][source_socket].RTT);
  Node__TCP_Timer__startPeriodic(100000);
}
...
#line 397
  sim_log_debug(130U, GENERAL_CHANNEL, "PING EVENT \n");
  sim_log_debug(131U, GENERAL_CHANNEL, "Packet source %d\n", TOS_NODE_ID);

  for (i = 0; i < Node__RouteTable__size(); i++) {
      r = Node__RouteTable__get(i);
      if (destination == (uint16_t )__nesc_ntoh_uint16(r.dest.nxdata) && __nesc_ntoh_uint16(r.cost.nxdata) < 20) {
          sim_log_debug(132U, ROUTING_CHANNEL, "Found a route!!! %d\n", __nesc_ntoh_uint16(r.nextHop.nxdata));
  ...
  if (i == Node__RouteTable__size()) {
      sim_log_debug(133U, GENERAL_CHANNEL, "No Path Found\n");
    }
}
...
#line 22
{
  if (!CommandHandlerP__Queue__empty()) {
      ...
      sim_log_debug(195U, COMMAND_CHANNEL, "A Command has been Issued.\n");
...
# 75 "/opt/tinyos-main/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP__TaskBasic__runTask(uint8_t arg_0x7fb89cc57020){
#line 75
  switch (arg_0x7fb89cc57020) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP__TaskBasic__default__runTask(arg_0x7fb89cc57020);
#line 75
      break;
#line 75
    }
...
#line 510
  if (Node__RouteTable__size() == 0) {
      ...
      sim_log_debug(138U, ROUTING_CHANNEL, "Creating table for: %d\n", TOS_NODE_ID);
      for (i = 0; i < Node__NeighborList__size(); i++) {
...
#line 558
  sim_log_debug(143U, GENERAL_CHANNEL, "Target Node: %d\n", dest_addr);
  Node__port_info[sim_node()][0] = srcPort;
  Node__port_info[sim_node()][1] = destPort;
  sim_log_debug(144U, GENERAL_CHANNEL, "want to open port: %d\n", Node__port_info[sim_node()][1]);
...
#line 91
        if (Node__sockets[sim_node()][i].state == SYN_RCVD) {
            Node__sockets[sim_node()][i].state = ESTABLISHED;
          }
        else {
#line 94
          if (Node__sockets[sim_node()][i].state == ESTABLISHED) {

              if (Node__sockets[sim_node()][i].flag == TOS_NODE_ID) {
                  for (j = 1; j <= 4; j++) {
...
#line 111
{
  sim_log_debug(110U, TRANSPORT_CHANNEL, "Timeout for %d\n", Node__nextPacket[sim_node()]);
}
...
# 83 "/opt/tinyos-main/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__fired(uint8_t arg_0x7fb89c3c0950){
#line 83
  switch (arg_0x7fb89c3c0950) {
#line 83
    case 0U:
#line 83
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__default__fired(arg_0x7fb89c3c0950);
#line 83
      break;
#line 83
    }
...
#line 577
{
  sim_log_debug(178U, "HplAtm128CompareC", "Cancelling compare at 0x%p\n", HplAtm128Timer0AsyncP__compare[sim_node()]);
...
#line 545
{
  if (HplAtm128Timer0AsyncP__overflow[sim_node()] != (void *)0) {
      ...
      sim_log_debug(177U, "HplAtm128Timer0AsyncP", "Cancelling overflow %p.\n", HplAtm128Timer0AsyncP__overflow[sim_node()]);
...
#line 481
{
  if (evt->cancelled) {
      ...
      if ((atm128RegFile[sim_node()][ATM128_TIMSK] & (1 << TOIE0)) != 0) {
          ...
          sim_log_debug(174U, "HplAtm128Timer0AsyncP", "Overflow interrupt at %s\n", sim_time_string());
          INTERRUPT_16();
        }
      else {
          sim_log_debug(175U, "HplAtm128Timer0AsyncP", "Setting overflow bit at %s\n", sim_time_string());
          atm128RegFile[sim_node()][ATM128_TIFR] |= 1 << TOV0;
        }
...
#line 299
  sim_log_debug(167U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Setting timer: %hhu\n", newVal);
  if (newVal == curVal) {
      return;
    }
  else {
...
#line 187
{
  sim_log_debug(157U, "HplAtm128Timer0AsyncP", "Beginning compare 0x%p at %s\n", evt, sim_time_string());
  if (evt->cancelled) {
      return;
    }
  else {
...
#line 194
      ...
      if ((atm128RegFile[sim_node()][ATM128_TIMSK] & (1 << OCIE0)) != 0) {
          ...
          sim_log_debug(163U, "HplAtm128Timer0AsyncP", "Compare interrupt @ %s\n", timeStr);
          INTERRUPT_15();
        }
      else {
          atm128RegFile[sim_node()][ATM128_TIFR] |= 1 << OCF0;
...
#line 225
  sim_log_debug(164U, "HplAtm128Timer0AsyncP", "Allocated compare at 0x%p\n", newEvent);
...
#line 364
{
  sim_log_debug(169U, "HplAtm128Timer0AsyncP", "Setting control to be 0x%hhx\n", x.flat);
...
#line 285
  ...
  sim_log_debug(166U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Getting timer: %hhu\n", rval);
  return rval;
}
...
#line 457
{
  sim_log_debug(172U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Getting compare: %hhu\n", * (volatile uint8_t *)&atm128RegFile[sim_node()][0x31]);
...
#line 590
  for (i = 0; i < Node__RouteTable__size(); i++) {
      ...
      if (dest_addr == (uint16_t )__nesc_ntoh_uint16(r.dest.nxdata) && __nesc_ntoh_uint16(r.cost.nxdata) < 255) {
          sim_log_debug(148U, ROUTING_CHANNEL, "next hop: %d\n", __nesc_ntoh_uint16(r.nextHop.nxdata));
...
#line 571
  sim_log_debug(145U, TRANSPORT_CHANNEL, "TCP Target Node: %d\n", dest_addr);
  sim_log_debug(146U, TRANSPORT_CHANNEL, "Sending seqNum: %d\n", Node__nextPacket[sim_node()]);
  Node__port_info[sim_node()][0] = srcPort;
  Node__port_info[sim_node()][1] = destPort;
  Node__port_info[sim_node()][2] = Node__nextPacket[sim_node()];
  Node__socket[sim_node()] = srcPort;
  sim_log_debug(147U, TRANSPORT_CHANNEL, "Frame %d\n", Node__port_info[sim_node()][2]);
  ...
  Node__nextPacket[sim_node()]++;
  Node__TCP_Timeout__startOneShot(4000);
...
#line 101
      sim_log_debug(152U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: TIFR is %hhx\n", tifr);
      if ((interrupt_in != 0 && interrupt_in < /*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm128AlarmAsyncP*/Atm128AlarmAsyncP__0__MINDT) || tifr & (1 << OCF0)) {
          if (interrupt_in < /*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm128AlarmAsyncP*/Atm128AlarmAsyncP__0__MINDT) {
              sim_log_debug(153U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: under min: %hhu.\n", interrupt_in);
            }
          else {
              sim_log_debug(154U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: OCF set.\n");
            }
          {
#line 109
            __nesc_atomic_end(__nesc_atomic); 
#line 109
      ...
      if (!/*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm128AlarmAsyncP*/Atm128AlarmAsyncP__0__set[sim_node()]) {
          ...
          sim_log_debug(155U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: no alarm set, set at max.\n");
        }
      else 
        {
...
#line 463
{
  sim_log_debug(173U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Setting compare: %hhu\n", t);
  /* atomic removed: atomic calls only */
#line 465
  {
...
#line 508
{
  ...
  sim_log_debug(176U, "HplAtm128Timer0AsyncP", "Scheduling new overflow for %i at time %llu\n", sim_node(), overflowTime);
...
#line 231
{
  ...
  sim_log_debug(165U, "HplAtm128Timer0AsyncP", "Configuring new compare of %i for %i at time %llu  (@ %llu)\n", (int )compareVal, sim_node(), compareTime, sim_time());
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  if (!strcmp(varname, "Node__packets_sender"))
  {
    *addr = (uintptr_t)&Node__packets_sender[__nesc_mote];
    *size = sizeof(Node__packets_sender[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "Node__packets_receiver"))
  {
    *addr = (uintptr_t)&Node__packets_receiver[__nesc_mote];
    *size = sizeof(Node__packets_receiver[__nesc_mote]);
    return 0;
  }
...
static void __nesc_nido_initialise(int __nesc_mote)
{
  ...
  Node__nextPacket[__nesc_mote] = 1;
  memset((void *)&Node__port_info[__nesc_mote], 0, sizeof Node__port_info[__nesc_mote]);
  memset((void *)&Node__packets_sender[__nesc_mote], 0, sizeof Node__packets_sender[__nesc_mote]);
  memset((void *)&Node__packets_receiver[__nesc_mote], 0, sizeof Node__packets_receiver[__nesc_mote]);
